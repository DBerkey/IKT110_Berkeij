...
AGENT_CONFIGS: List[Dict[str, object]] = [
    {"name": "Adaptive v1", "path": "dnd_agents/run_adaptive_v1.py", "enabled": False},
    {"name": "Aggressive Bot", "path": "dnd_agents/run_aggressive_bot.py", "enabled": False},
    {"name": "Aggressive Debt Bot", "path": "dnd_agents/run_aggressive_debt_bot.py", "enabled": False},
    {"name": "Smart Ultimate", "path": "dnd_agents/run_smart_ultimate_agent.py", "enabled": False},
    ...
    {"name": "Braavos Inflation", "path": "dnd_agents/run_braavos_inflation_agent.py", "enabled": False},
    {"name": "Interest Split v2", "path": "dnd_agents/run_interest_split_v2_agent.py", "enabled": False},
    {"name": "Braavos Optimal", "path": "dnd_agents/run_braavos_optimal_agent.py", "enabled": True},
    {"name": "Braavos Sentinel", "path": "dnd_agents/run_braavos_sentinel_agent.py", "enabled": False},
    {"name": "Braavos Phoenix", "path": "dnd_agents/run_braavos_phoenix_agent.py", "enabled": False},
    {"name": "Braavos Learning", "path": "dnd_agents/run_braavos_learning_agent.py", "enabled": False},
    {"name": "Braavos lockdown", "path": "dnd_agents/run_braavos_lockdown_agent.py", "enabled": False},
    {"name": "Braavos Centurion", "path": "dnd_agents/run_braavos_centurion_agent.py", "enabled": False},
    {"name": "Braavos Legion", "path": "dnd_agents/run_braavos_legion_agent.py", "enabled": False},
    {"name": "Braavos Vanguard", "path": "dnd_agents/run_braavos_vanguard_agent.py", "enabled": False},
    {"name": "Braavos Overdrive", "path": "dnd_agents/run_braavos_overdrive_agent.py", "enabled": False},
    {"name": "Simple Mean Bidder", "path": "dnd_agents/run_simple_mean_bidder_agent.py", "enabled": False},
    {"name": "Pool Mean Bidder", "path": "dnd_agents/run_pool_mean_bidder_agent.py", "enabled": False},
    ...
    {"name": "Neural Bidder", "path": "dnd_agents/run_neural_bidder_agent.py", "enabled": False},
    ...
    {"name": "Compound Crusher", "path": "dnd_agents/run_compound_crusher_agent.py", "enabled": False},
    {"name": "Compound Crusher v2", "path": "dnd_agents/melk.py", "enabled": True},
    {"name": "Moha_2", "path": "dnd_agents/run_2.py", "enabled": False},
    {"name": "interest_split_v2", "path": "dnd_agents/run_interest_split_v2_agent.py", "enabled": False},
]
